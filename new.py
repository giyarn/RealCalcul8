...
def quadratic():
    ...
    quad_bg_image = PhotoImage(file='numbers/backgroubd.png')
    quad_canvas = Canvas(quad_window, width=800, height=500)
    quad_canvas.pack(fill='both', expand=True)
    quad_canvas.create_image(0, 0, image=bg_image, anchor=NW)
    quad_canvas.create_text(320, 150, text="Welcome to Calc-U-l8!", font=("Lemonade Stand", 30))
